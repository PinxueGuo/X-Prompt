...
class RandomAffine(object):
    ...
    def __call__(self, img, mask):
        ...
        img = TF.affine(img, angle=ret[0],translate=ret[1],scale=ret[2],shear=ret[3],interpolation=self.resample, fill=self.fillcolor)
        mask = TF.affine(mask, *ret, interpolation=Image.NEAREST, fill=0)
        return img, mask
